...
// TODO(student) B.3: declare your rolling-window latency accumulators
// here — e.g. a sample count, a running sum (microseconds), and the
// min and max seen so far. You'll reset them each time the window
// fills (>= 100 inferences).
}  // namespace
...
void loop() {
  ...
  // TODO(student) B.3: capture micros() immediately BEFORE Invoke().
